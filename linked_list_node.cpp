...
void anyIn(int data, int place)
{
    ...
    if (place == 1)
    {
        ...
        head = tmp;
        cout << endl
             << "# Node " << data << " will be inserted at the place " << place << "." << endl;
        return;
    }
    ...
    {
        cout << endl
             << "# Can NOT insert node " << data << " to place " << place << "." << endl;
...
void delPl(int place)
{
    ...
    {
        cout << endl
             << "# Can NOT delete an empty list." << endl;
        return;
    }
    ...
    {
        cout << endl
             << "# Can NOT delete the node at place " << place << "." << endl;
...
delete_announce:
    cout << endl
         << "# Node " << del_node << " at place " << place << " has been deleted." << endl;
    return;
}
...
void delVa(int value)
{
    ...
    {
        cout << endl
             << "# Node " << value << " at the beginning has been deleted." << endl;
        head = NULL;
        return;
    }
    ...
    {
        cout << endl
             << "# Node " << value << " is not appearing in the list." << endl;
        return;
    }
    if (ptr->next->data == value)
    {
        place++;
        cout << endl
             << "# Node " << ptr->next->data << " at place " << place << " has been deleted." << endl;
        ptr->next = ptr->next->next;
        return;
    }
}
...
void sortA_bubble()
{
    ...
    {
        cout << endl
             << "# Can NOT sort an empty list." << endl;
        return;
    }
    if (head->next == NULL)
    {
        cout << endl
             << "# Can NOT sort a list with only node." << endl;
        return;
    }
...
void findN(int value)
{
    ...
    while (ptr != NULL)
    {
        ...
        {
            cout << endl
                 << "# Node " << value << " stay at place " << place << "." << endl;
            return;
        }
        ptr = ptr->next;
    }
    cout << endl
         << "# Can NOT find node " << value << " in the list." << endl;
}
